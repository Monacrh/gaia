...
const EarthLoader: React.FC = () => {
  return (
    <div className="earth flex flex-col items-center justify-center">
      <div className="earth-loader relative w-30 h-30 bg-[#3344c1] rounded-full overflow-hidden border-[0.15em] border-white animate-startround">
        <svg
          className="absolute bottom-[-2em] w-28 h-auto animate-round1 animation-delay-750"
        ...
        <svg
          className="absolute top-[-3em] w-28 h-auto animate-round1"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 200 200"
        >
          <path
        ...
        <svg
          className="absolute top-[-2.5em] w-28 h-auto animate-round2"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 200 200"
        >
          <path
        ...
        <svg
          className="absolute bottom-[-2.2em] w-28 h-auto animate-round2 animation-delay-750"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 200 200"
        >
          <path
      ...
      <p className="text-white pt-1 text-xl font-sans flex justify-center items-center">
        Connecting...
      </p>
    </div>
  );
